...
class Risk:
    ...
    def grafico(self):
        ...
        plt.plot(self.x_risk, self.lowR_mf, label="LowR")
        plt.plot(self.x_risk, self.mediumR_mf, label="MediumR")
        plt.plot(self.x_risk, self.highR_mf, label="HighR")
    ...
    def grafico_combinado(self, low, med, high, centroide):
        ...
        MediumR_cutoff = np.minimum(self.mediumR_mf, med)
